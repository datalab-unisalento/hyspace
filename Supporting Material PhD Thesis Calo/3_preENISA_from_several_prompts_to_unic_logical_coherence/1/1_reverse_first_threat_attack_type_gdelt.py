...
Original file is located at
    https://colab.research.google.com/drive/1QoiiW5EaOjfesIDbQ1wzAnj7ILlFQfbT
"""
...
df = pd.read_csv('/content/marco_ds_c.150_newspaper_with_attack_type.csv')  # Replace with actual file path
...
df.to_csv('/content/4_gdelt_marco_reverse.csv', index=False)
...
df = pd.read_csv('/content/4_gdelt_marco_reverse.csv')
