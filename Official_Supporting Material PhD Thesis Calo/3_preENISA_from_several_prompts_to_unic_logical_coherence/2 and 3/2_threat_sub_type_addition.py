...
Original file is located at
    https://colab.research.google.com/drive/12VRxgLkMOT4EyiqdJnvOtFrdmP4aXpUJ
"""
...
df = pd.read_csv('/content/5_gdelt_marco_reverse_attribut.csv')  # Replace with actual file path
...
# Load the dataset (make sure the dataset path is correct)
df = pd.read_excel('/content/EMM_attributi.xlsx')  # Replace with actual file path
...
df.to_csv('threats_emm_plus.csv', index=False)
